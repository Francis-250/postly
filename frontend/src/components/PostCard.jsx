...
const PostCard = ({ featured_image, created_at, subtitle, index }) => {
  return (
    <div className="flex flex-col gap-3 w-auto  ">
      ...
      <p className="text-black fonr-semibold text-md w-full line-clamp-2">
        {subtitle}
      </p>
      <p className="text-sm text-gray-500">
        <span className="">{created_at} </span>
        <span className="text-[#366489]   ">by Leon</span>
      </p>
    </div>
  );
};
